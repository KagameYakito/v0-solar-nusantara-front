        ...
        products: [
          {
            ...
            image: 'https://via.placeholder.com/300x300?text=SOLIS+Inverter',
          },
          {
            id: 'solis-offgrid-2',
            name: 'SOLIS Hybrid Inverter 5kW',
            description: 'Grid-tied and battery capable',
            image: 'https://via.placeholder.com/300x300?text=SOLIS+Hybrid',
          },
          {
            id: 'solis-offgrid-3',
            name: 'SOLIS Off-Grid Inverter 6kW',
            description: '3-phase output, industrial grade',
            image: 'https://via.placeholder.com/300x300?text=SOLIS+6kW',
          },
        ],
      },
      {
        ...
        products: [
          {
            ...
            image: 'https://via.placeholder.com/300x300?text=LUMINOUS+4kVA',
          },
          {
            id: 'luminous-sp-2',
            name: 'LUMINOUS Single Phase Inverter 5kVA',
            description: 'Built-in MPPT controller',
            image: 'https://via.placeholder.com/300x300?text=LUMINOUS+5kVA',
          },
        ],
      },
      {
        ...
        products: [
          {
            ...
            image: 'https://via.placeholder.com/300x300?text=String+10kW',
          },
          {
            id: 'string-3phase-2',
            name: 'String Inverter 15kW 3-Phase',
            description: 'Commercial grade, IP65 rated',
            image: 'https://via.placeholder.com/300x300?text=String+15kW',
          },
        ],
      },
    ],
        ...
        products: [
          {
            ...
            image: 'https://via.placeholder.com/300x300?text=Trina+425Wp',
          },
          {
            id: 'trina-425-2',
            name: 'Trina Solar Panel 425Wp Bifacial',
            description: 'Bifacial technology, higher yield',
            image: 'https://via.placeholder.com/300x300?text=Trina+Bifacial',
          },
        ],
      },
      {
        ...
        products: [
          {
            ...
            image: 'https://via.placeholder.com/300x300?text=Jinko+625Wp',
          },
          {
            id: 'jinko-625-2',
            name: 'Jinko Solar Panel 650Wp',
            description: 'Latest generation, 23% efficiency',
            image: 'https://via.placeholder.com/300x300?text=Jinko+650Wp',
          },
          {
            id: 'jinko-625-3',
            name: 'Jinko Solar Panel 670Wp',
            description: 'Premium tier, highest efficiency',
            image: 'https://via.placeholder.com/300x300?text=Jinko+670Wp',
          },
        ],
      },
      {
